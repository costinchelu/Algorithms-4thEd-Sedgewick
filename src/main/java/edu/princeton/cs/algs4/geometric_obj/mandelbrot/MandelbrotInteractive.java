...
public class MandelbrotInteractive extends JFrame {
    ...
    public static void main(String[] args) {
        new MandelbrotInteractive(2048, 1080);
        // (800, 600), (1024, 768), (1600, 900), (1920, 1080)
    ...
    public MandelbrotInteractive(int width, int height) {
        this(width, height, .005, -2.61, -1.435);
    }

    public MandelbrotInteractive(int width, int height, double Zoom, double r, double i) {
        this(width, height, new double[]{Zoom, r, i});
    }

    public MandelbrotInteractive(int width, int height, double[]... points) {
    ...
    private MouseAdapter mouseAdapter = new MouseAdapter() {
        ...
        private void acceptIf(int value, Predicate<Integer> p, Consumer<Integer> c) {
            if (p.test(value)) c.accept(value);
        }

        private Predicate<Integer> ge(int md) {
            return v -> v >= md;
        }

        private Predicate<Integer> le(int md) {
            return v -> v <= md;
        }
