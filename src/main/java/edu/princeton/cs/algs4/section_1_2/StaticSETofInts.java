...
/**
 * The {@code StaticSETofInts} class represents a set of integers. It supports
 * searching for a given integer is in the set. It accomplishes this by keeping
 * the set of integers in a sorted array and using binary search to find the
 * given integer.
 * <p>
...
public class StaticSETofInts {
   ...
   /**
    * Returns either the index of the search key in the sorted array (if the key is
    ...
    * @param key
    *           the search key
    * @return the number of keys in this set less than the key (if the key is in
    *         the set) or -1 (if the key is not in the set).
    */
