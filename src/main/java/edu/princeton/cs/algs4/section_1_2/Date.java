...
/**
 * The {@code Date} class is an immutable data type to encapsulate a date (day,
 * month, and year).
 * <p>
...
public class Date implements Comparable<Date> {
    ...
    * Compares two dates chronologically.
    *
    * @return the value {@code 0} if the argument date is equal to this date; a
    *         negative integer if this date is chronologically less than the
    *         argument date; and a positive integer if this date is chronologically
